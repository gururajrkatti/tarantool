...
# To respect CMP0002
set(LUAJIT_TEST_TARGET OFF CACHE BOOL "Generate <test> target" FORCE)
set(BUILDMODE static CACHE STRING "Build mode: build only static lib" FORCE)
set(LUAJIT_SMART_STRINGS ON CACHE BOOL "Harder string hashing function" FORCE)
if(CMAKE_BUILD_TYPE STREQUAL "Debug")
    set(LUAJIT_USE_APICHECK ON CACHE BOOL "Assertions for the Lua/C API" FORCE)
    set(LUAJIT_USE_ASSERT ON CACHE BOOL "Assertions for the whole LuaJIT VM" FORCE)
endif()
if(ENABLE_VALGRIND)
    set(LUAJIT_USE_SYSMALLOC ON CACHE BOOL "System provided memory allocator (realloc)" FORCE)
    set(LUAJIT_USE_VALGRIND ON CACHE BOOL "Valgrind support" FORCE)
endif()
...
add_subdirectory(${LUAJIT_SOURCE_ROOT})
